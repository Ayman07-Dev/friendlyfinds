        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            <div className="p-10 text-center">
              <h2 className="text-3xl font-black uppercase tracking-tighter mb-10">Admin Login</h2>
              
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="text-left space-y-2">
                  <label className="text-[12px] font-black uppercase tracking-[0.3em] ml-1">Username</label>
                  <input
                    type="text"
                    required
                    value={email}
                ...
                {error && (
                  <p className="text-red-400 text-xs font-medium bg-red-400/10 py-2 rounded-lg">{error}</p>
                )}
